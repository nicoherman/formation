...
const imageUrl = "/avatar" + user?.gender + ".png"

  return (
    <section className='w-full h-screen flex items-center justify-center flex-col bg-blue-200'>
...
{user && (
<section>
<div className={user.gender === 'male' ? '"w-96 px-6 py-6  text-center bg-gray-600 rounded-lg lg:mt-0 xl:px-10"' :'"w-96 px-6 py-6  text-center bg-red-300 rounded-lg lg:mt-0 xl:px-10"' }>
<div className="space-y-4 xl:space-y-6">   
    <Image 
              className='text-white'
              src={imageUrl} //Image de remplacement
              width={800} 
              height={800}
              alt="Avatar"
              onLoad={()=>{
