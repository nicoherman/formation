...
export default function PageMembers() {
        ...
        const fetchUsers = async ()=> {
            try{
                startTransition(async ()=> {
                    ...
                    if(!response.ok){
                        throw new Error('An error has occured while fetching the data')
                    }
  ...
  return (
    <section className='w-full flex items-center justify-center flex-col'>
        <h1 className='w-full text-3xl text-center font-black uppercase bg-gray-300'>
            Page des membres
        </h1>
...
<div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 p-3 md:p-4 xl:p-5 dark:bg-gray-900">
             {users.map(user => (
                ...
                <div key={user.id} className="w-96 px-6 py-6  text-center bg-gray-800 rounded-lg lg:mt-0 xl:px-10">
                <div className="space-y-4 xl:space-y-6">   
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-center items-center flex-col space-y-3 text-lg font-medium leading-6">
                            ...
                            <p className="text-orange-300">{user.country}</p>
